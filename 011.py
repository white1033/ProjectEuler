...
my_input = """08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08
...
maxp = 0
row, col, token = 20, 20, 4
for i in xrange(row):
    for j in xrange(col - token + 1):
	phv = max(grid[i][j] * grid[i][j + 1] * grid[i][j + 2] * grid[i][j + 3],
                  grid[j][i] * grid[j + 1][i] * grid[j + 2][i] * grid[j + 3][i])
	if i < row-token:
	    pd = max(grid[i][j] * grid[i + 1][j + 1] * grid[i + 2][j + 2] * grid[i + 3][j + 3],
